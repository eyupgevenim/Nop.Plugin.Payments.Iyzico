namespace Nop.Plugin.Payments.Iyzico.Components
{
    ...
    [ViewComponent(Name = IyzicoDefaults.PAYMENT_INFO_VIEW_COMPONENT_NAME)]
    public class IyzicoPaymentViewComponent : NopViewComponent
    {
        private readonly IyzicoSettings _iyzicoSettings;
        public IyzicoPaymentViewComponent(IyzicoSettings iyzicoSettings)
        {
